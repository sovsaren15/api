...
const { validateScore } = require('../middleware/validation.middleware.js');
...
router.post('', authenticate, authorize('MANAGE_SCORES'), validateScore, scoresController.createOrUpdate);
